			...
			<tr>
				<td valign="top">
					<form action='j_security_check' id="loginForm" method="post"
						class="loginbox" autocomplete="on">
							...
							<tbody>
								...
								<tr valign="top">
									...
									<td width="50%" align="left"><input name="j_username"
										type="text" id="j_username" /></td>
								</tr>
								<tr>
									<td width="50%" align="right"><label id="password">Password</label></td>
									<td width="50%" align="left"><input name="j_password"
										type="password" id="j_password" /></td>
								</tr>
								<tr>
									<td colspan="2" width="100%" align="center"><input
										type="submit" id="submit" value="Log In" /></td>
								</tr>
								<tr>
									<td colspan="2" width="100%" align="center"><h2>
											<font color="red"></font>
										</h2></td>
								</tr>
								<tr>
